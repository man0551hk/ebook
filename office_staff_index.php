...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function LoadImage() {
        for(var i = 1; i <= 45; i++) {
          var fileName = 'RL(EN)_0613-' + i.toString().padStart(2, '0') + '.jpg';
          var image = "<div id = 'image" + i + "'  name = 'image" + i + "'>";
          image += "<img src = 'pdf/RL(EN)_0613/" + fileName + "' class = '" + imageClass + "' />";
          image += "</div>";
      ...
      async function LoadSubIndex() {
        ...
        xmlhttp.open("GET", "json/officeSubIndex0613.json", true);
        xmlhttp.send();
      }
      ...
      async function LoadIndex() {
        ...
        xmlhttp.open("GET", "json/officeIndex.json", true);
        xmlhttp.send();
      }    
  ...
  <body>
    ...
    <div class="container" id = "container">
      ...
      <div class = "row" id = "indexRow">
        <a href = "javascript:BackIndex()" style = "padding-bottom:15px;padding-left:40px;display:none;" id = "backIndex">Back to Program List</a>
            ...
            <div class = "row" style = "padding-bottom:15px;padding-left:10px;">
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB1"><img src = "images/bBtn.png"/><span class = "spanText" >Back of House Support</span></label>
                    <input type = "checkbox" value = "B" ID = "programCB1" onChange = "SetSelectedArray('programCB1', 'B')"> 
                  </div>
              </div>
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB4"><img src = "images/sdBtn.png"/><span class = "spanText" >Senior Directors</span></label>
                    <input type = "checkbox" value = "SD" ID = "programCB4" onChange = "SetSelectedArray('programCB4', 'SD')">
                  </div>
              </div>
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB2"><img src = "images/dBtn.png"/><span class = "spanText" >Directors</span></label>
                    <input type = "checkbox" value = "D" ID = "programCB2" onChange = "SetSelectedArray('programCB2', 'D')">
                  </div>
              </div>          
            </div>

            <div class = "row" style = "padding-bottom:25px;padding-left:10px;">
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB3"><img src = "images/aBtn.png"/><span class = "spanText" >Associates</span></label>
                    <input type = "checkbox" value = "A" ID = "programCB3" onChange = "SetSelectedArray('programCB3', 'A')"> 
                  </div>
              </div>
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB5"><img src = "images/mBtn.png"/><span class = "spanText" >Managers</span></label>
                    <input type = "checkbox" value = "M" ID = "programCB5" onChange = "SetSelectedArray('programCB5', 'M')">
                  </div>
              </div>
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB6"><img src = "images/vpBtn.png"/><span class = "spanText" >Vice Presidents</span></label>
                    <input type = "checkbox" value = "VP" ID = "programCB6" onChange = "SetSelectedArray('programCB6', 'VP')">
                  </div>
              </div>          
            </div>

            <div class = "row" style = "padding-bottom:25px;">
                <div class = "col" id = "heading" style="" >
                  PROGRAMS<br/>
                  AT A GLANCE
                </div>
            </div>

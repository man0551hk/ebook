...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function LoadImage() {
        for(var i = 1; i <= 38; i++) {
          var fileName = 'RL(TC)_0613-' + i.toString().padStart(2, '0') + '.jpg';
          var image = "<div id = 'image" + i + "'  name = 'image" + i + "'>";
          image += "<img src = 'pdf/RL(TC)_0613/" + fileName + "' class = '" + imageClass + "' />";
          image += "</div>";
      ...
      async function LoadSubIndex() {
        ...
        xmlhttp.open("GET", "json/storeSubIndexTC0613.json", true);
        xmlhttp.send();
      }
      ...
      async function LoadIndex() {
        ...
        xmlhttp.open("GET", "json/storeIndexTC.json", true);
        xmlhttp.send();
      }    
  ...
  <body>
    ...
    <div class="container" id = "container">
      ...
      <div class = "row" id = "indexRow">
        <a href = "javascript:BackIndex()" style = "padding-bottom:15px;padding-left:40px;display:none;" id = "backIndex">返回目錄 Back to Program List</a>
            ...
            <div class = "row" style = "padding-bottom:15px;padding-left:10px;">
              <div class = "col-md-5 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB1"><img src = "images/bBtn.png"/><span class = "spanText" >後勤支援 Back of House Support</span></label>
                    <input type = "checkbox" value = "B" ID = "programCB1" onChange = "SetSelectedArray('programCB1', 'B')"> 
                  </div>
              </div>       
              <div class = "col-md-4 col-12" style = "padding-bottom:5px;" >
                  <div class="checkbox-container">
                    <label for="programCB3"><img src = "images/aBtn.png"/><span class = "spanText" >員工 Associates</span></label>
              ...
              <div class = "col-md-3 col-12" >
                  <div class="checkbox-container" style = "padding-bottom:5px;" >
                    <label for="programCB5"><img src = "images/mBtn.png"/><span class = "spanText" >經理 Managers</span></label>

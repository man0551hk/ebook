      ...
      <div class = "row" id = "indexRow">
        <div id = "indexDiv">
          ...
          <div id = "menuContent" style = "padding:10px;">
              <b>亲爱的Ralph Lauren 员工</b><br/>
              Dear Ralph Lauren Employees,
              <br/><br/>
              
              我们非常开心地和所有店铺员工分享这使人兴奋的学习目录。 <br/>
              本目录结合所有教育领域的学习课程，包括专业发展、产品知识，以及销售和服务。 <br/>
              我们的目标是向每一位Ralph Lauren的员工提供均等的发展机会。 <br/>
              无论你是在我们的任何一家店铺工作，你即刻就有可以进一步发展的学习工具。 <br/>
              祝你好运和享受学习！<br/><br/>

              We are pleased to share this exciting Learning Catalogue with all employees in
              our offices and our stores.<br/>
              For the first time, this catalogue combines learning curriculums across all areas
              of education, including professional development, product knowledge and sales
              & service.<br/>
              The objective is to offer everyone an equal opportunity to develop themselves
              as Ralph Lauren Employees.<br/>
              Whether you work in one of our stores or the office, you now have the tools you
              need to further your education as an employee.<br/>
              Good Luck and Enjoy!
              <br/>
              <br/>
              <a href = 'store_staff_sc_index.php'><img src = "images/nextBtn.png" class = "img-fluid" width = "100px" /></a>
          </div>
        </div>
      </div>

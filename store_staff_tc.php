      ...
      <div class = "row" id = "indexRow">
        <div id = "indexDiv">
          ...
          <div id = "menuContent" style = "padding:10px;">
              <b>親愛的Ralph Lauren 員工</b><br/>
              Dear Ralph Lauren Employees,
              <br/><br/>
              我們非常開心地和所有店舖員工分享這使人興奮的學習目錄。<br/>
              本目錄結合所有教育領域的學習課程，包括專業發展、產品知識，以及銷售和服務。<br/>
              我們的目標是向每一位Ralph Lauren的員工提供均等的發展機會。<br/>
              無論你是在我們的任何一家店舖工作，你即刻就有可以進一步發展的學習工具。<br/>
              祝你好運和享受學習！<br/><br/>
              ...
              <br/>
              <br/>
              <a href = 'store_staff_tc_index.php'><img src = "images/nextBtn.png" class = "img-fluid" width = "100px" /></a>
          </div>
        </div>
      </div>
